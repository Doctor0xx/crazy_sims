...
namespace SIMSAPI.Controllers
{
    ...
    public class AuthService : ControllerBase
    {
        ...
        private bool checkUser(string username, string password)
        {
            ...
            {
                bool result = false;
                string connectionString = Environment.GetEnvironmentVariable("postgresdb") ?? "Host=database-incident-app.camynshuuemw.ap-northeast-1.rds.amazonaws.com;Username=incidentappuser;Password=FwO0)]JKfmporr$J6ET67T-W5>#T;Database=postgres;Ssl Mode=Require;";
